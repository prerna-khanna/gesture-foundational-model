...
def handle_argv(target, config_train, prefix):
    ...
    parser.add_argument('dataset', type=str, help='Dataset name', choices=['hhar', 'motion', 'uci', 'shoaib', 'blind_user', 'sighted_user', 'blind_fine_tune', 'blind_access_wear','Turiya', 'Alexandra', 'Julius', 'sony_watch', 'blind_user_filtered', 'earbud_filtered'])
...
def handle_argv_simple():
    ...
    parser.add_argument('dataset', type=str, help='Dataset name', choices=['hhar', 'motion', 'uci', 'shoaib','merge', 'blind_access_wear'])
