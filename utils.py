...
def handle_argv(target, config_train, prefix):
    ...
    parser.add_argument('dataset', type=str, help='Dataset name', choices=['hhar', 'motion', 'uci', 'shoaib', 'blind_user', 'sighted_user', 'blind_fine_tune', 'blind_access_wear','Turiya', 'Alexandra', 'Julius'])
