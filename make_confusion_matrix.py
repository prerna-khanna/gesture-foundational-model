...
def plot_confusion_matrix(csv_file, output_dir='./plots', filename=None):
    ...
    if filename is None:
        ...
        output_file = os.path.join(output_dir, f"{base_name}_confusion_matrix.png")
    else:
        output_file = os.path.join(output_dir, filename)
    
    # Copy the generated file to the specified output directory
    if os.path.exists('confusion_matrix_new.png'):
        import shutil
...
if __name__ == "__main__":
    # Example usage
    # Single file
    plot_confusion_matrix("results/final_results/earbud_filtered_10_03_10_2025_05_15/results.csv")
