...
if __name__ == "__main__":
    label_rates = [0.3, 0.5, 0.8]
    save_path = input("Enter save path for model with dataset and (blind_user_filtered): ")
    for label_rate in label_rates:
        try:
            ...
            if grid_search_enabled:
                ...
                # append label_rate to save_path
                save_path_ = save_path
                save_path = save_path + "_" + str(int(label_rate*100))
